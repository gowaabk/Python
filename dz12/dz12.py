...
if __name__ == '__main__':
    ...
    stud = Student("Иванов", "Иван", "Иванович", PATH)
   
    stud.new_estimate("Russian", 5)
    # print(stud.lessons)

    stud.new_estimate("English", 2)
    stud.new_estimate("Physics", 2)
    stud.new_estimate("Physics", 4)
    stud.new_estimate("Math", 4)
    stud.new_estimate("Russian", 4)
    stud.new_estimate("English", 5)
    stud.new_estimate("Physics", 2)
    stud.new_estimate("Math", 4)
    stud.new_estimate("Physics", 3)
    stud.new_estimate("Math", 61, "test")
    stud.new_estimate("Math", 78, "test")
    stud.new_estimate("Russian", 79, "test")
    stud.new_estimate("Russian", 93, "test")
    stud.new_estimate("English", 89, "test")
    stud.new_estimate("Biology", 95, "test")
    stud.new_estimate("Biology", 74, "test")
    stud.new_estimate("English", 78, "test")
    print(stud)